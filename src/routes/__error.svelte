...
let showMorseCodeLink: boolean = false;
let showLastRiddle: boolean = false;

function HandleMorseCodeButtonPressed(event: any)
{
    showMorseCodeLink = true;
}

function HandleLastRiddleButtonPressed(event:any)
{
    showLastRiddle = true;
}
</script>
...
<main>
    ...
    <div>
        <h3>Whoops ich glaub du hast dich verlaufen hier ein paar Tips was falsch gelaufen sein könnte</h3>
        <span></span>
        <ul>
            <li>Schreibfehler, Schreibfehler, Schreibfehler solltest mal checken ob du deutsch schreiben kann</li>
            <li>Naja vielleicht hast du auch was durcheinander gebracht. Schau mal auf die Reihenfolge vllt ist da was falsch</li>
            {#if showMorseCodeLink}
            <li><a sveltekit:prefetch href="/morsecode">Hier kommst du zum Morsealphabet</a></li>
            {/if}
            {#if showLastRiddle}
            <li><a sveltekit:prefetch href="/uebertragung/vermittlung/transport">Hier kommst du zum letzten Rätsel</a></li>
            {/if}
        </ul>
        <div class="buttonPanel">
            <button class="buttonPanelButton" on:click={HandleMorseCodeButtonPressed}>Zeige Tipp für Morsezeichen</button>
            <button class="buttonPanelButton" on:click={HandleLastRiddleButtonPressed}>Zeige Tipp für das letzte Rätsel</button>
        </div>
    </div>
</main>
